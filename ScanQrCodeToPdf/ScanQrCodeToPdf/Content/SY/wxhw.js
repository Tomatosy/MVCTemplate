var wxhw = {
    showFormModal: function (options) {//title,html,button,click
        var modalhtml = "<div class='modal fade bs-example-modal-sm' tabindex='-1' role='dialog' aria-labelledby='mySmallModalLabel'>" +
   ...
   " <div class='modal-header'>" +
      ...
      "<div class='modal-footer'>" +
       " <button type='button' class='btn btn-default' data-dismiss='modal'>关闭</button>" +
        "<button type='button' class='btn btn-primary'>" + options.button + "</button>" +
      "</div>" +
"</div></div></div>";
