...
(function ($) {
    ...
    abp.localization.abpWeb = abp.localization.getSource('YdmCodeArtCore');
    ...
    abp.message.error = function (message, title) {
        abp.log.error('abp.message.error is not implemented!');
        if (message.indexOf("内部错误")!=-1) {
            return showMessage("系统繁忙,请稍后在试", "系统繁忙");
        }
        return showMessage(message, title);
    };
    ...
    ************************************************************/
     ...
     */
    abp.utils.setCookieValue = function (key, value, days, path, domain) {
